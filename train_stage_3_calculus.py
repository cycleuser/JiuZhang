#!/usr/bin/env python3
"""JiuZhang Math Model - Stage 3: Calculus
Stage 3 of 4
Epochs: 2
"""
...
OUTPUT_DIR = "/private/var/folders/h0/64ycsy616rbb9rsm15zj4tpm0000gn/T/pytest-of-fred/pytest-70/test_generate_all_scripts0/model/stage_3"
PREV_STAGE_DIR = "/private/var/folders/h0/64ycsy616rbb9rsm15zj4tpm0000gn/T/pytest-of-fred/pytest-70/test_generate_all_scripts0/model/stage_2" if stage_num > 1 else None
MAX_SEQ_LENGTH = 1024
BATCH_SIZE = 1
...
stage_data = all_data.filter(lambda x: "calculus" in x.get("category", "").lower() or 
                             "calculus" in x.get("problem_id", "").lower())
